...
<head>
    ...
    <link rel="stylesheet" href="addpass.css">
</head>
<body>
    <section>
        <div class="signupform-box">
            <div class="form-value">
                <form name = "signup" action="addpass.php" method="POST">
                    ...
                    <div class="inputbox">
                        ...
                        <input type="text" name="webpass" placeholder = "Password" required>
                    </div>
                    <!-- <button type="submit" class="btn" onclick='pwd_maker()'>Show Password</button> -->
                    <button type="submit" class="btn" name="add_pass">SAVE</button>
                </form>
            </div>
        </div>
    </section>
